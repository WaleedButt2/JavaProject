...
public class Remove_Friends extends HttpServlet {
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String axe=nc.searchFriend((String)session.getAttribute("email"),Email);
        if(axe.compareTo("")==0){
        ...
        nc.UnFriend((String)session.getAttribute("email"), Email);
        out.println("Deletion Sucessfull<br>");
        out.println("<form action=\"./Manage_Friends\" method=\"post\">");
        out.println("<input type=\"submit\" value=\"<--Go Back\">");
        out.println("</body></html>");
    }
